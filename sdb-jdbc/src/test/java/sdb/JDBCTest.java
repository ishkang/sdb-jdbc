...
public class JDBCTest
{
    ...
    public void enableLoadExtensionTest() throws Exception {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:sdb:", prop);
    ...
    public void majorVersion() throws Exception {
        int major = DriverManager.getDriver("jdbc:sdb:").getMajorVersion();
        int minor = DriverManager.getDriver("jdbc:sdb:").getMinorVersion();
    }
