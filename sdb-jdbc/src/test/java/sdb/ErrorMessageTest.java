...
public class ErrorMessageTest {
    ...
    public void moved() throws SQLException, IOException {
        ...
        Connection conn = DriverManager.getConnection("jdbc:sdb:" + from.getAbsolutePath());
    ...
    public void writeProtected() throws SQLException, IOException {
        ...
        Connection conn = DriverManager.getConnection("jdbc:sdb:" + file.getAbsolutePath());
        Statement stmt = conn.createStatement();
        stmt.executeUpdate("create table sample(id, name)");
        stmt.executeUpdate("insert into sample values(1, \"foo\")");
        stmt.close();
        ...
        conn = DriverManager.getConnection("jdbc:sdb:" + file.getAbsolutePath());
